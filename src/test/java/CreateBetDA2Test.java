...
import dataAccess.DataAccessDaSilva2;
import domain.Bet;
import domain.Event;
...
class CreateBetDA2Test {

	static DataAccessDaSilva2 sut = new DataAccessDaSilva2(ConfigXML.getInstance().getDataBaseOpenMode().equals("initialize"));;
	static DataAccessDaSilva2 testDA = new DataAccessDaSilva2(ConfigXML.getInstance().getDataBaseOpenMode().equals("initialize"));
	private Event ev;
